...
|---|---|---|---|---|---|---|---|---|
| 1 | **Clínica Anielly Vilela \| Estética Avançada** | 4.9 ★ | 42 | (64) 99336-8698 | **Do Zero** | *(Nenhum)* | Serviços de alto valor (Ultraformer III, preenchimento e botox). Sem site oficial para captar buscas locais. | novo |
| 2 | **Dra. Rosana Vecchi \| Rejuvenescimento Facial** | 4.8 ★ | 38 | (62) 98515-0061 | **Do Zero** | *(Nenhum)* | Clínica no Edifício Eleve (Setor Oeste) com procedimentos premium (Endolift, fios, Ultraformer). Sem portal web. | novo |
| 3 | **Dra. Anna Clara Junqueira** | 4.8 ★ | 31 | (64) 99314-7000 | **Do Zero** | *(Nenhum)* | Atendimento na Clínica Mais Saúde (Jd. Roma). Presente apenas em guias terceiros, sem página de autoridade própria. | novo |
